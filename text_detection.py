...
# we set the new width and height and then determine the ratio in change
...
# we construct a blob from the image and then perform a forward pass of
...
for y in range(0, numRows):
	...
	for x in range(0, numCols):
		...
		# we compute both the starting and ending (x, y)-coordinates for
...
# we apply non-maxima suppression to suppress weak, overlapping bounding
# boxes
